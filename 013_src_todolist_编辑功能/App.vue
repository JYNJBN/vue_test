...
<script>
	...
	export default {
		...
		mounted() {
			...
			this.$bus.$on('modifyItems', this.modifyItems);
		},
		beforeDestroy() {
			this.$bus.$off(['changeState', 'deleteItems', 'modifyItems']);
		},
	};
</script>
...
<style>
	...
	.btn-normal {
		color: #fff;
		background-color: #45be77;
		border: 1px solid #45be77;
	}
